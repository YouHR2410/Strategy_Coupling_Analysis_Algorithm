...
def A5_matrix_X(a_value,mode_col):
    ...
    eigen = D_V_F.subs([(x1,0.2),(x2,0.2),(x3,0.2),(x4,0.2),(x5,0.2)]).eigenvects()

    eigenvector1 = eigen[0][2][0]
    eigenvector2 = eigen[1][2][0]
    eigenvector3 = eigen[2][2][0]
    eigenvector4 = eigen[3][2][0]
    eigenvector5 = eigen[4][2][0]

    eigenvectormatrix = Matrix([eigenvector1.T, eigenvector2.T , eigenvector3.T,eigenvector4.T,eigenvector5.T]).T

    V2 = payoff_matrix.subs([(a,a_value)]) * eigenvectormatrix.subs([(a,a_value)]) 
    V3 = V2[:,mode_col]
